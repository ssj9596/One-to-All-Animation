...
try:
    ...
    try:
        ...
        from flash_attn.flash_attn_interface import flash_attn_varlen_func as flash_attn2_varlen_func
...
def get_cu_seqlens_wotxt(text_mask, img_len):
    """Calculate cu_seqlens_q, cu_seqlens_kv using text_mask and img_len
...
def attention(
    ...
    if mode == "torch":
        ...
        if flash_attn_backend == "flash-attn-3":
            x, _ = flash_attn3_varlen_func(
                q, k, v,
                cu_seqlens_q, cu_seqlens_kv,
                max_seqlen_q, max_seqlen_kv,
            )
        elif flash_attn_backend == "flash-attn-2":
            x = flash_attn2_varlen_func(
                q, k, v,
                cu_seqlens_q, cu_seqlens_kv,
                max_seqlen_q, max_seqlen_kv,
        )
