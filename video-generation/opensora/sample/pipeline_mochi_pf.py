...
from opensora.model_variants import MochiTransformer3DModel
...
class MochiPipeline(DiffusionPipeline):
    ...
    def _get_t5_prompt_embeds(
        ...
        prompt_embeds = self.text_encoder(text_input_ids.to(device), prompt_attention_mask)[0]
    ...
    def __call__(
        ...
        for i_s in range(stages):
            ...
            if i_s > 0:
                ...
                if not self.scheduler.invert_sigmas:
                    ori_sigma = 1 - self.scheduler.ori_start_sigmas[i_s]   # the original coeff of signal
                else:
                    ori_sigma = self.scheduler.ori_start_sigmas[i_s]
                gamma = self.scheduler.config.gamma
                # 两处没有问题
            ...
            with self.progress_bar(total=len(timesteps)) as progress_bar:
                for i, t in enumerate(timesteps):
                    ...
                    noise_pred_uncond = self.transformer(
                        ...
                        encoder_attention_mask=prompt_attention_mask[0:1],
                        return_dict=False,
                    )[0]
        ...
        return ImagePipelineOutput(images=video)
